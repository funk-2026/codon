...
export default function UsersMenuRoute() {
  ...
  const cards = [
    { key: 'users', label: 'Users List', icon: <Users size={26} color={color('accent/default')} weight="duotone" />, href: '/(admin)/(users)/users-list' },
  ];
