    ...
    <SafeAreaView style={[styles.container, { backgroundColor: color('bg/canvas') }]}>
      ...
      >
        <View style={{ alignItems: 'center', marginTop: space.lg }}>
          ...
          {editingName ? (
            <TextInput
              ...
              autoFocus
              style={[type['type/h2'], { color: color('text/primary'), marginTop: space.sm, textAlign: 'center', minWidth: 160 }]}
            />
          ) : (
            <Pressable onPress={() => setEditingName(true)} style={[styles.nameRow, { marginTop: space.sm }]} hitSlop={space.xs}>
          ...
          <View style={[styles.chipRow, { gap: space.xs, marginTop: space['2xs'] }]}>
        ...
        <View style={{ marginTop: space.xl }}>
          <Text style={[type['type/overline'], { color: color('text/tertiary'), marginBottom: space.sm }]}>APPEARANCE</Text>
        ...
        <View style={{ marginTop: space.lg }}>
          <Text style={[type['type/overline'], { color: color('text/tertiary'), marginBottom: space.sm }]}>PREFERENCES</Text>
          <View style={[styles.row, { backgroundColor: color('bg/surface'), borderRadius: radius.md, padding: space.md }]}>
        ...
        <View style={{ marginTop: space['2xl'], alignItems: 'center' }}>
          ...
          />
          <Text style={[type['type/caption'], { color: color('text/tertiary'), marginTop: space.md }]}>Codon v1.0.0</Text>
        </View>
      </ScrollView>
